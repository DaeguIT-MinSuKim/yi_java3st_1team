...
public class Login03Panel extends JPanel {
	...
	private void initialize() {
		...
		label_2.setBounds(162, 103, 164, 91);
		add(label_2);
		...
		label_3.setBounds(162, 235, 164, 45);
		add(label_3);
	}
}
